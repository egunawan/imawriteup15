...
%PSNR is the abbreviation for Peak Signal-to-Noise Ratio.
...
%Specifically, the maximum possible error on any one pixel is $\min\big\{\sum_{i,j=1}^n(2^{t_{ij}}-1),\text{MAX}_P\big\}$. 
